...
public class XiaohaopinlingquEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public XiaohaopinlingquEntity() {
		
	}
	
	public XiaohaopinlingquEntity(T t) {
		try {
	 ...
	 * 设置：领取理由
	 */
	public void setLingquliyou(String lingquliyou) {
		this.lingquliyou = lingquliyou;
	}
	/**
	 * 获取：领取理由
	 */
	public String getLingquliyou() {
		return lingquliyou;
	}
	/**
	 * 设置：用户名
