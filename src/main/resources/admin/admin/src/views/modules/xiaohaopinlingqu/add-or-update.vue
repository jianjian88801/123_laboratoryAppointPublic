<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="消耗品编号" prop="xiaohaopinbianhao">
          <el-input v-model="ruleForm.xiaohaopinbianhao" 
              placeholder="消耗品编号" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="消耗品编号" prop="xiaohaopinbianhao">
              <el-input v-model="ruleForm.xiaohaopinbianhao" 
                placeholder="消耗品编号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="消耗品名称" prop="xiaohaopinmingcheng">
          <el-input v-model="ruleForm.xiaohaopinmingcheng" 
              placeholder="消耗品名称" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="消耗品名称" prop="xiaohaopinmingcheng">
              <el-input v-model="ruleForm.xiaohaopinmingcheng" 
                placeholder="消耗品名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        ...
        <el-form-item class="input" v-if="type!='info'"  label="身份" prop="shenfen">
          <el-input v-model="ruleForm.shenfen" 
              placeholder="身份" clearable ></el-input>
        </el-form-item>
        <div v-else>
          ...
          <el-form-item class="input" v-if="ruleForm.shenqingshijian" label="申请时间" prop="shenqingshijian">
              <el-input v-model="ruleForm.shenqingshijian" 
                placeholder="申请时间" readonly></el-input>
                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                  <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="领取理由" prop="lingquliyou">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.lingquliyou" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.lingquliyou" label="领取理由" prop="lingquliyou">
                    <span v-html="ruleForm.lingquliyou"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
                    if(o=='xiaohaopinbianhao'){
            this.ruleForm.xiaohaopinbianhao = obj[o];
            continue;
          }
                    if(o=='xiaohaopinmingcheng'){
            this.ruleForm.xiaohaopinmingcheng = obj[o];
            continue;
          }
                    if(o=='shuliang'){
            ...
            continue;
                    ...
                    if(o=='lingquliyou'){
            this.ruleForm.lingquliyou = obj[o];
            continue;
          }
                    if(o=='yonghuming'){
    ...
    onSubmit() {
      ...
      this.$http({
        ...
        if (valid) {
          this.$http({
            url: `xiaohaopinlingqu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xiaohaopinlingquCrossAddOrUpdateFlag = false;
                  this.parent.search();
