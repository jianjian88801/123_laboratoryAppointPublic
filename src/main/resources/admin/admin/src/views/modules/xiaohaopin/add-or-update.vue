  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.xiaohaopinbianhao" label="消耗品编号" prop="xiaohaopinbianhao">
              <el-input v-model="ruleForm.xiaohaopinbianhao" 
                placeholder="消耗品编号" readonly></el-input>
          </el-form-item>
        </div>
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
            ruleForm: {
                        xiaohaopinbianhao: this.getUUID(),
                        	        xiaohaopinmingcheng: '',
	                        	        tupian: '',
	                        	        shuliang: '',
	                        	        weizhi: '',
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `xiaohaopin/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xiaohaopinCrossAddOrUpdateFlag = false;
                  this.parent.search();
